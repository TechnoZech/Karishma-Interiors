	...
	return (
		<section className="privacy_section">
			<div className="privacy_container">
				...
				<p>Welcome to Karishma Interiors!</p>

				<p>
					These terms and conditions outline the rules and regulations for the
					use of Karishma Interiors's Website, located at
					https://www.karishmainteriors.in/.
				</p>

				<p>
					By accessing this website we assume you accept these terms and
					conditions. Do not continue to use Karishma Interiors if you do not
				...
				<p>
					We employ the use of cookies. By accessing Karishma Interiors, you
					agreed to use cookies in agreement with the Karishma Interiors's
					Privacy Policy.{" "}
				</p>
				...
				<p>
					Unless otherwise stated, Karishma Interiors and/or its licensors own
					the intellectual property rights for all material on Karishma
					Interiors. All intellectual property rights are reserved. You may
					access this from Karishma Interiors for your own personal use
					subjected to restrictions set in these terms and conditions.
				</p>

				<p>You must not:</p>
				<ul>
					<li>Republish material from Karishma Interiors</li>
					<li>Sell, rent or sub-license material from Karishma Interiors</li>
					<li>Reproduce, duplicate or copy material from Karishma Interiors</li>
					<li>Redistribute content from Karishma Interiors</li>
				</ul>
				...
				<p>
					...
					Karishma Interiors does not filter, edit, publish or review Comments
					prior to their presence on the website. Comments do not reflect the
					views and opinions of Karishma Interiors,its agents and/or affiliates.
					...
					Karishma Interiors shall not be liable for the Comments or for any
				...
				<p>
					Karishma Interiors reserves the right to monitor all Comments and to
				...
				<p>
					You hereby grant Karishma Interiors a non-exclusive license to use,
				...
				<p>
					...
					the hyperlink compensates the absence of Karishma Interiors; and (d)
				...
				<p>
					...
					sending an e-mail to Karishma Interiors. Please include your name,
				...
				<p>
					No use of Karishma Interiors's logo or other artwork will be allowed
